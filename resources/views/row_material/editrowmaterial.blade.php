...
@section('title', 'Row Material Edit')
...
@section('content')
    ...
    <div class="content">
        ...
        <div class="page-header ">
            <div class="page-title">
                <h4>Edit Row Material</h4>
            </div>
             <div class="back-button">
                <a href="{{ route('row_material.list') }}" class="btn back-button"> <i class="fa-solid fa-arrow-left"></i> Back</a></br>
                ...
                <form id="productForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label class="form-label-icon"><i class="fa-solid fa-image"></i> Row Material Image</label>
    ...
    @push('js')
        ...
        <script>
            ...
            $(document).on("click", ".remove-image", function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "/api/remove-row-material-image",
                            type: "POST",
                            headers: {
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        title: "Deleted!",
                                        text: "Row material image removed successfully!",
                                        icon: "success",
                                        confirmButtonColor: "#ff9f43"
                                    }).then(() => {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status) {
                                Swal.fire({
                                    title: "Success!",
                                    text: "Row material updated successfully!",
                                    icon: "success",
            ...
            $(document).ready(function() {
                ...
                // 🔹 Load Row Material and prefill form
                $.ajax({
                    url: `/api/edit-row-material/${productId}`,
                    method: 'GET',
                    headers: {
                        Authorization: `Bearer ${authToken}`
                    },
